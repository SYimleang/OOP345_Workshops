...
namespace sdds
{
	// Function compares the profiles in the two received DataBase objects by raw pointers. 
	// Two profiles are considered same if they have same age and name.
	// Returns a copy of Profile objects
	DataBase<Profile> excludeRaw(const DataBase<Profile>& allProfiles, const DataBase<Profile>& bannedProfiles);

	// Function compares the profiles in the two received DataBase objects by smart pointers. 
	// Two profiles are considered same if they have same age and name.
	// Returns a copy of Profile objects
